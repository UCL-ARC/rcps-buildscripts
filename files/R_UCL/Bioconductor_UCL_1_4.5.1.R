...
BiocManager::install ("KEGGREST", type="source", lib=mainLib);
...
BiocManager::install ("zlibbioc", type="source", lib=mainLib); (NOT AVAILABLE FOR Bioconductor version '3.22')
...
#::install ("beanplot", type="source", lib=mainLib);
...
#::install ("ChAMPdata", type="source", lib=mainLib);
