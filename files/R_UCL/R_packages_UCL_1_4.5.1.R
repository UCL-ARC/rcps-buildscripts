...
install.packages ("Matrix", lib=mainLib, repos=repros);
...
install.packages ("magrittr", lib=mainLib, repos=repros);
install.packages ("shiny", lib=mainLib, repos=repros);
install.packages ("vctrs", lib=mainLib, repos=repros);
install.packages ("cluster", lib=mainLib, repos=repros);
install.packages ("foreign", lib=mainLib, repos=repros);
install.packages ("stringi", lib=mainLib, repos=repros);
