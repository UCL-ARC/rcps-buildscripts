...
export PKG_LIBS="-L/shared/ucl/apps/udunits/2.2.28/lib"
...
export PKG_CONFIG_PATH=$PKG_CONFIG_PATH\:/usr/lib64/pkgconfig:/shared/ucl/apps/udunits/2.2.28:/shared/ucl/apps/NetCDF/4.9.2-intel-2022/
