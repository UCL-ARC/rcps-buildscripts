...
udunits2Conf <- '--with-udunits2-include=/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/udunits-2.2.28-7k5tsjgycgmhrhdarctbt7exdxsjcxbu/include --with-udunits2-lib=/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/udunits-2.2.28-7k5tsjgycgmhrhdarctbt7exdxsjcxbu/lib';
...
RmpfrConf <- '--with-mpfr-include=/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/mpfr-4.2.1-sr64udbzkumnxp4i7ptdt4org2xxhird/include --with-mpfr-lib=/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/mpfr-4.2.1-sr64udbzkumnxp4i7ptdt4org2xxhird/lib';
...
Sys.setenv(INCLUDE_DIR="/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/jq-1.7.1-qm4xcbnyijfrrit2ykbbm5rkhhxqnr4m/include");
Sys.setenv(LIB_DIR="/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/jq-1.7.1-qm4xcbnyijfrrit2ykbbm5rkhhxqnr4m/lib");
...
Sys.setenv(JPEG_LIBS="-L/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/libjpeg-turbo-3.0.3-72nb3zcslrdlxocfdtuwvxeiegv6oieh/lib64");
Sys.setenv(JPEG_CFLAGS="-I/lustre/apps/spack/0.23/deploy/2026-03/spack/opt/spack/linux-rhel9-cascadelake/gcc-12.3.0/libjpeg-turbo-3.0.3-72nb3zcslrdlxocfdtuwvxeiegv6oieh/include");
